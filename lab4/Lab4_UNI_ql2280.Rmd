...
P1972 = P99[year == 1972];P1972
P1942 = P99.5[year == 1942];P1942
p1922 = P99.9[year == 1922];p1922
```
...
labs(main = "Rich time through time",x = "year",y="rich poeple")
```
...
exponent.est_ratio = function(P99,P99.9){
  a = 1-log(10)/log(as.numeric(P99)/as.numeric(P99.9))
  return(a)
  }
...
P99.5 = wtid.report$V4
P99.9 = wtid.report$V5
exponent.est_ratio(P99,P99.9)
plot(year,exponent.est_ratio(P99,P99.9),ylab = "estimated a",xlab = "year")
```
...
P99.5 = wtid.report$V4
P99.9 = wtid.report$V5
a = 1-log(5)/log(as.numeric(P99.5)/as.numeric(P99.9))
p5 = function(P99.5,P99.9,a){
  b = (as.numeric(P99.5)/as.numeric(P99.9))^(1-a)
  return(b)
  }
p5(P99.5,P99.9,a)
plot(p5(P99.5,P99.9,a))
```
...
```{r}
a = 1-log(2)/log(as.numeric(P99.5)/as.numeric(P99.9))
p5(P99.5,P99.9,a)
```
